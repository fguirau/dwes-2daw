...
Bienvenido a los apuntes de **DWES** de 2º DAW del **IES Torrevigía**.

## Unidades didácticas

| Unidad | Contenidos |
|--------|-----------|
| [UD1 - Introducción y Arquitectura Web](ud1/01_introduccion_arquitectura.md) | Modelo cliente-servidor, arquitectura 3 capas, páginas dinámicas, XAMPP, VS Code |
| [UD2 - El Lenguaje PHP](ud2/01_lenguaje_php.md) | Variables, Estructuras de Control, Estructuras de Repetición, Arrays, Funciones |
